...
function SidebarContent({ onNavigate }) {
  ...
  return (
    <Nav className="flex-column h-100 px-3">
      <Nav.Link as={NavLink} to="/user" end onClick={onNavigate}>
        <HomeIcon /> Kezdőlap
      </Nav.Link>

      <Nav.Link as={NavLink} to="/user/Treatments" onClick={onNavigate}>
        <ListIcon /> Kezeléseim
      </Nav.Link>

      <Nav.Link as={NavLink} to="/user/Profile" onClick={onNavigate}>
        <UserIcon /> Profilom
      </Nav.Link>

      <Nav.Link as={NavLink} to="/user/Contact" onClick={onNavigate}>
        <PhoneIcon /> Kapcsolat
      </Nav.Link>
